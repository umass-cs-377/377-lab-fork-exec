...
Answer the following questions about pointers. All code that is written or that you write should be treated as though it is at the commented section above.
